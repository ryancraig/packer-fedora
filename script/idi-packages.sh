...
${PKG_MGR} install -y glib2-devel PackageKit-glib-devel json-glib-devel libXrandr-devel libXrender-devel libX11-devel xorg-x11-proto-devel alsa-lib-devel tuxguitar firefox-38.0.1 google-chrome-stable
